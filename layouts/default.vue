...
<!--      <SideBar v-if="sideBar">-->
      <!-- Sidebar -->
      <div v-if="sideBar" class="z-10 absolute top-0 bottom-0 left-0 md:relative w-full max-w-[200px] flex-shrink-0 border-r border-slate-800 shadow bg-gray-900 text-white overflow-y-auto pb-20 md:pb-0">
