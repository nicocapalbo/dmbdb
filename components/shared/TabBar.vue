...
<template>
  <div class="border-b border-gray-200 dark:border-gray-700">
    <div class="flex -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
      <div
        ...
        class="flex items-center justify-center gap-1 md:gap-2 px-2 md:px-4 py-2 border-b-2 border-transparent rounded-t-lg text-slate-300 hover:text-blue-400 hover:border-blue-400 dark:hover:text-blue-400 group cursor-pointer"
